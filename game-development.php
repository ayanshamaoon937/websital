...
<head>
    ...
    <title>Game Development — Websital | Perth WA</title>
    <meta name="description"
          content="Websital builds games with Unity and Unreal—gameplay, art, multiplayer, monetization, and liveops. Perth‑based game development studio.">
        ...
        <main>
                            ...
                            <div class="col-lg-12">
                                <div class="pp-service-details-heading pb-55 tp_fade_anim mb-80" data-delay=".3">
                                    <h3 class="pp-service-details-title">
                                        ...
                                        Built to Last <span>Unity/Unreal <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        fill="#FFF669"/></svg></span>
                                    </h3>
                                </div>
                                <div class="pp-service-details-about-wrap ">
                                    <div class="pp-about-content tp_text_anim">
                                        <p>
                                            We create engaging games with solid core loops, polished art, and optimized
                                            performance. From prototypes to liveops, we handle gameplay programming,
                                            multiplayer, monetization, and publishing.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gx-0">
                            <div class="col-lg-4 col-md-6">
                                <div class="pp-service-details-about-item mb-30 tp_fade_anim" data-delay=".3">
                                    <span><i data-purecounter-duration="1" data-purecounter-end="70"
                                             class="purecounter">0</i> %</span>
                                    <p>Player <br> Retention</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="pp-service-details-about-item mb-30 tp_fade_anim" data-delay=".5">
                                    <span><i data-purecounter-duration="1" data-purecounter-end="40"
                                             class="purecounter">0</i> %</span>
                                    <p>ARPU <br> Increase</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="pp-service-details-about-item mb-30 tp_fade_anim" data-delay=".7">
                                    <span><i data-purecounter-duration="1" data-purecounter-end="99"
                                             class="purecounter">0</i> %</span>
                                    <p>Uptime for <br> Liveops</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tp-service-4-banner-area p-relative">
                <div class="ar-banner-wrap ar-about-us-4">
                    <img class="w-100" src="assets/img/services-new/game-development-1976-1319.webp" alt=""
                         data-speed=".8">
                </div>
            </div>
            <!-- banner area end -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pp-service-details-overview-heading">
                                <h4 class="pp-service-details-overview-title tp_fade_anim" data-delay=".3">Service
                                    Overview</h4>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="pp-service-details-overview-wrapper">
                                <p>
                                    Unity and Unreal development across mobile, PC, and console. We optimize rendering,
                                    input, physics, and memory—ensuring smooth FPS and engaging gameplay.
                                </p>
                                ...
                                <div class="pp-service-details-overview-list">
                                    <ul>
                                        <li>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="10"
                                                    ...
                                                    <path d="M9.50631 0.886963L4.26771 6.12552L1.49369 3.35158L0 4.84527L4.26771 9.11302L11 2.38065L9.50631 0.886963Z"
                                                          fill="white"/>
                                                </svg>
                                            </span>
                                        ...
                                        <li>
                                            ...
                                            </span>Multiplayer, backend, telemetry
                                        </li>
                                        <li>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="10" viewBox="0 0 11 10" fill="none">
                                                    <path d="M9.50631 0.886963L4.26771 6.12552L1.49369 3.35158L0 4.84527L4.26771 9.11302L11 2.38065L9.50631 0.886963Z" fill="white"/>
                                                </svg>
                                            </span>
                                            Monetization, QA, publishing
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="tp-service-4-solution-item service-details mb-30 tp_fade_anim" data-delay=".3">
                                <div class="tp-service-4-solution-item-content">
                                    <h4 class="tp-service-4-solution-item-title">Gameplay & Systems</h4>
                                    <ul>
                                        <li>+ Input, physics, camera</li>
                                        <li>+ AI, spawning, progression</li>
                                        <li>+ Tools & level editors</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="tp-service-4-solution-item service-details mb-30 tp_fade_anim" data-delay=".5">
                                <div class="tp-service-4-solution-item-content">
                                    <h4 class="tp-service-4-solution-item-title">Art & Audio</h4>
                                    <ul>
                                        <li>+ Stylized/realistic art</li>
                                        <li>+ Animation & VFX</li>
                                        <li>+ SFX & music integration</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="tp-service-4-solution-item service-details mb-30 tp_fade_anim" data-delay=".7">
                                <div class="tp-service-4-solution-item-content">
                                    <h4 class="tp-service-4-solution-item-title">Liveops & Monetization</h4>
                                    <ul>
                                        <li>+ Events, A/B tests, telemetry</li>
                                        <li>+ IAP, ads mediation</li>
            ...
            <div class="pp-service-details-thumb-ptb pb-90">
                <div class="container container-1430">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <a target="_blank"
                               href="https://play.google.com/store/apps/details?id=com.technoTactics.offline.bike.stunt.racing.gGame&hl=en"
                               class="pp-service-details-thumb fix mb-30">
                                <div class="tp_img_reveal">
                                    <img src="assets/img/project/game-project-1.webp" alt="">
                                </div>
                                <div class="text-white h2 mt-4">
                                    Moto Wheelie 3d - Bike Master
                                </div>
                        ...
                        <div class="col-lg-6">
                            <a target="_blank"
                               href="https://apps.apple.com/ee/app/gangster-empire-3d-crime/id6742738272"
                               class="pp-service-details-thumb fix mb-30">
                                <div class="tp_img_reveal">
                                    <img src="assets/img/project/game-project-2.webp" alt="">
                                </div>
                                <div class="text-white h2 mt-4">
                                    Gangster Empire 3D: Crime
                                </div>
            ...
            <div class="pp-service-details-process-ptb pt-130 pb-90" data-bg-color="#1B1B1D">
                <div class="container container-1350">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pp-service-details-process-heading text-center pb-100 tp_fade_anim"
                                 data-delay=".3">
                                <span class="pp-service-details-process-subtitle"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                            viewBox="0 0 10 10" fill="none"><circle cx="5" cy="5" r="5"
                                                                                    fill="currentColor"/></svg> Working Process</span>
                                <h3 class="pp-service-details-process-title">Prototype. Playtest. Polish.</h3>
                            </div>
                        </div>
                    </div>
                    <div class="pp-service-details-process-box z-index-1 pb-40 tp_fade_anim" data-delay=".5">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <div class="pp-service-details-process-item text-center mb-30"><span>01</span><h4>
                                        Concept</h4>
                                    <p>Vision, genre, audience.</p></div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="pp-service-details-process-item text-center mb-30"><span>02</span><h4>
                                        Prototype</h4>
                                    <p>Core loop and feel.</p></div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="pp-service-details-process-item text-center mb-30"><span>03</span><h4>
                                        Production</h4>
                                    <p>Content, art, features.</p></div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="pp-service-details-process-item text-center mb-30"><span>04</span><h4>
                                        Launch</h4>
                                    <p>Publish and liveops.</p></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pp-service-details-process-bottom text-center">
                                <span>Have a game idea? <a href="contact-us"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                  width="25" height="11"
                                                                                  viewBox="0 0 25 11" fill="none"><path
                                                    ...
                                                    fill="currentColor"/></svg> Let’s Talk</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tp-service-5-price-ptb pt-160 pb-140">
                <div class="container container-1230">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="tp-service-5-price-heading service-details d-flex align-items-start pb-70 tp_fade_anim">
                                ...
                                <h3 class="tp-career-title fs-100">Indie to <br> enterprise</h3>
                            </div>
                        </div>
                    </div>
                    <div class="tp-service-5-price-item service-details tp_fade_anim">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="tp-service-5-price-item-heading"><h4 class="tp-service-5-price-item-title">
                                        Prototype</h4></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="tp-service-5-price-item-list">
                                    <ul>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            stroke="white"
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Core
                                            loop demo
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Temp
                                            art & SFX
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>1
                                            platform
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="tp-service-5-price-item-head text-lg-end"><h4>$900</h4></div>
                            </div>
                        </div>
                    </div>
                    <div class="tp-service-5-price-item service-details tp_fade_anim">
                        <div class="row">
                                    ...
                                    <ul>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Full
                                            art & audio
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Content
                                            pipeline
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Multiplayer
                                            optional
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="tp-service-5-price-item-head text-lg-end"><h4>$2,200</h4></div>
                            </div>
                        </div>
                    </div>
                    <div class="tp-service-5-price-item service-details tp_fade_anim">
                        <div class="row">
                                    ...
                                    <ul>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Events
                                            & updates
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Analytics
                                            & A/B tests
                                        </li>
                                        <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9"
                                                       viewBox="0 0 12 9" fill="none"><path d="M11 1L4.125 8L1 4.81818"
                                                                                            ...
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"/></svg></span>Support
                                            & ops
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="tp-service-5-price-item-head text-lg-end"><h4>$3,500</h4></div>
                            </div>
                        </div>
                    </div>
                </div>
